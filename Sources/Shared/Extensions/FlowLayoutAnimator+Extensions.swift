...
extension CollectionViewFlowLayoutAnimator {
  ...
  private func applyAnimation(_ animation: FlowLayoutAnimation,
                              type: FlowLayoutAnimationType,
    ...
    let excludedAnimationTypes: [FlowLayoutAnimation] = [.top, .bottom]
